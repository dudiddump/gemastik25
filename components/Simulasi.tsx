    ...
    <section className="bg-gray-50">
      <ResponsiveContainer>
        <div className="mt-5 max-w-4xl mx-auto px-4">
          ...
          {results && (
            <div className="py-5 text-center bg-white rounded-xl shadow-md">
              ...
              <p className="mt-1 max-w-md mx-auto text-gray-500">Dengan uang sebanyak itu, kamu bisa beli motor, DP rumah, atau mulai bisnis. Mau tunggu sampai kapan?</p>
