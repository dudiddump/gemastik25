      ...
      <ResponsiveContainer>
        <section className="text-center">
          ...
          <div className="flex justify-center mt-3">
            <a 
              href="/register" 
              className="inline-block bg-green-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-green-700 transition-all duration-300 shadow-lg text-lg transform hover:scale-105"
            >
              Mulai Sekarang!
            </a>
          </div>
